$(document).ready(function() {
    ...
    function toggle_project_choice(id1, id2) {
        ...
        $("#" + id2 + "_choice").find(':input:checkbox').each(function(index, element) { //reset input
            console.log(element);
    ...
    $("input[name=carte_langues]").change(function() {
        $(".langue").fadeToggle();
    });
    $("input[name=carte_referencement]").change(function() {
        $(".seo").fadeToggle();
    });
